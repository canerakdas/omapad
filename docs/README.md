...
| [`conventions/procedures.md`](conventions/procedures.md) | The procedures themselves: when a job earns one, how it is named, the three sentences its trigger is made of, and why nothing in the tree is addressed to an agent. |
